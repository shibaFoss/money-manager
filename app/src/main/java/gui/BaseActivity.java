...
public abstract class BaseActivity extends LocalizationActivity {
    ...
    public void showSimpleMessageBox(final String message, final SingleButtonCallback callback) {
        AsyncJob.doInMainThread(new AsyncJob.MainThreadJob() {
            @Override
            public void doInUIThread() {
                DialogUtility.getDefaultBuilder(BaseActivity.this)
    ...
    public void showSimpleHtmlMessageBox(final String message) {
        AsyncJob.doInMainThread(new AsyncJob.MainThreadJob() {
            ...
            public void doInUIThread() {
                ...
                else msg = Html.fromHtml(message);
    ...
    @TargetApi(Build.VERSION_CODES.N)
    public void showSimpleHtmlMessageBox(final String message,
                                         final SingleButtonCallback callback) {
        AsyncJob.doInMainThread(new AsyncJob.MainThreadJob() {
            @Override
            public void doInUIThread() {
                Spanned msg = null;
